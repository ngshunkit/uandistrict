...
import { Calendar, Users, TrendingUp, ChevronRight, ChevronLeft } from "lucide-react";
              ...
              <div className="grid gap-8 md:grid-cols-3 mb-12">
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="mb-2 text-xl font-semibold">{t("offerings.subpages.retirement.features.regular.title")}</h3>
                    <p className="text-muted-foreground">{t("offerings.subpages.retirement.features.regular.description")}</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-6 text-center">
                    <Users className="mx-auto mb-4 h-12 w-12 text-primary" />
                    <h3 className="mb-2 text-xl font-semibold">{t("offerings.subpages.retirement.features.senior.title")}</h3>
                    <p className="text-muted-foreground">{t("offerings.subpages.retirement.features.senior.description")}</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-6 text-center">
                    <TrendingUp className="mx-auto mb-4 h-12 w-12 text-primary" />
                    <h3 className="mb-2 text-xl font-semibold">{t("offerings.subpages.retirement.features.leads.title")}</h3>
                    <p className="text-muted-foreground">{t("offerings.subpages.retirement.features.leads.description")}</p>
                  </CardContent>
                </Card>
              </div>
